...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.subtitle_mask_check = QtWidgets.QCheckBox(self.layoutWidget)
        self.subtitle_mask_check.setText(tr("Blur original subtitle area"))
        self.subtitle_mask_check.setToolTip(tr("Blur the original subtitle region before embedding new subtitles"))

        self.subtitle_mask_x_label = QtWidgets.QLabel("X:")
        self.subtitle_mask_x = QtWidgets.QSpinBox()
        self.subtitle_mask_x.setRange(0, 7680)
        self.subtitle_mask_x.setMaximumWidth(70)
        self.subtitle_mask_x.setToolTip("X coordinate (pixel)")

        self.subtitle_mask_y_label = QtWidgets.QLabel("Y:")
        self.subtitle_mask_y = QtWidgets.QSpinBox()
        self.subtitle_mask_y.setRange(0, 4320)
        self.subtitle_mask_y.setMaximumWidth(70)
        self.subtitle_mask_y.setToolTip("Y coordinate (pixel)")

        self.subtitle_mask_w_label = QtWidgets.QLabel("W:")
        self.subtitle_mask_w = QtWidgets.QSpinBox()
        self.subtitle_mask_w.setRange(0, 7680)
        self.subtitle_mask_w.setMaximumWidth(70)
        self.subtitle_mask_w.setToolTip("Width (pixel)")

        self.subtitle_mask_h_label = QtWidgets.QLabel("H:")
        self.subtitle_mask_h = QtWidgets.QSpinBox()
        self.subtitle_mask_h.setRange(0, 4320)
        self.subtitle_mask_h.setMaximumWidth(70)
        self.subtitle_mask_h.setToolTip("Height (pixel)")

        self.subtitle_mask_band_label = QtWidgets.QLabel("Band:")
        self.subtitle_mask_band = QtWidgets.QSpinBox()
        self.subtitle_mask_band.setRange(0, 100)
        self.subtitle_mask_band.setValue(10)
        self.subtitle_mask_band.setMaximumWidth(70)
        self.subtitle_mask_band.setToolTip(tr("Edge blur band (not supported by bundled ffmpeg, reserved)"))
        self.subtitle_mask_band.setVisible(False)
        self.subtitle_mask_band_label.setVisible(False)

        self.subtitle_mask_layout = QtWidgets.QHBoxLayout()
        self.subtitle_mask_layout.addWidget(self.subtitle_mask_check)
        self.subtitle_mask_layout.addWidget(self.subtitle_mask_x_label)
        self.subtitle_mask_layout.addWidget(self.subtitle_mask_x)
        self.subtitle_mask_layout.addWidget(self.subtitle_mask_y_label)
        self.subtitle_mask_layout.addWidget(self.subtitle_mask_y)
        self.subtitle_mask_layout.addWidget(self.subtitle_mask_w_label)
        self.subtitle_mask_layout.addWidget(self.subtitle_mask_w)
        self.subtitle_mask_layout.addWidget(self.subtitle_mask_h_label)
        self.subtitle_mask_layout.addWidget(self.subtitle_mask_h)
        self.subtitle_mask_layout.addWidget(self.subtitle_mask_band_label)
        self.subtitle_mask_layout.addWidget(self.subtitle_mask_band)
        self.subtitle_mask_layout.addStretch()
        ...
        self.adv_layout_outer.addLayout(self.subtitle_mask_layout)  # 模糊原字幕
        self.verticalLayout_3.addWidget(self.advcontainer)
        self.advcontainer.setVisible(False)

        # === Slideshow Creator Widgets (hidden by default) ===
        self.slideshow_container = QtWidgets.QWidget(self.layoutWidget)
        self.slideshow_container.setObjectName("slideshow_container")
        self.slideshow_layout = QtWidgets.QVBoxLayout(self.slideshow_container)
        self.slideshow_layout.setContentsMargins(0, 0, 0, 6)
        self.slideshow_layout.setSpacing(6)

        # Row 1: Script file + Image directory
        self.slideshow_row1 = QtWidgets.QHBoxLayout()
        self.slideshow_script_btn = QtWidgets.QPushButton(self.slideshow_container)
        self.slideshow_script_btn.setMinimumSize(QtCore.QSize(140, 30))
        self.slideshow_script_btn.setObjectName("slideshow_script_btn")
        self.slideshow_script_label = QtWidgets.QLabel(self.slideshow_container)
        self.slideshow_script_label.setObjectName("slideshow_script_label")
        self.slideshow_image_btn = QtWidgets.QPushButton(self.slideshow_container)
        self.slideshow_image_btn.setMinimumSize(QtCore.QSize(140, 30))
        self.slideshow_image_btn.setObjectName("slideshow_image_btn")
        self.slideshow_image_label = QtWidgets.QLabel(self.slideshow_container)
        self.slideshow_image_label.setObjectName("slideshow_image_label")
        self.slideshow_row1.addWidget(self.slideshow_script_btn)
        self.slideshow_row1.addWidget(self.slideshow_script_label)
        self.slideshow_row1.addWidget(self.slideshow_image_btn)
        self.slideshow_row1.addWidget(self.slideshow_image_label)
        self.slideshow_row1.addStretch()
        self.slideshow_layout.addLayout(self.slideshow_row1)

        # Row 2: TTS settings
        self.slideshow_row2 = QtWidgets.QHBoxLayout()
        self.slideshow_tts_label = QtWidgets.QLabel(self.slideshow_container)
        self.slideshow_tts_label.setStyleSheet("background-color:transparent")
        self.slideshow_tts_label.setObjectName("slideshow_tts_label")
        self.slideshow_tts_type = QtWidgets.QComboBox(self.slideshow_container)
        self.slideshow_tts_type.setMinimumSize(QtCore.QSize(180, 30))
        self.slideshow_tts_type.setObjectName("slideshow_tts_type")
        self.slideshow_voice_label = QtWidgets.QLabel(self.slideshow_container)
        self.slideshow_voice_label.setStyleSheet("background-color:transparent")
        self.slideshow_voice_label.setObjectName("slideshow_voice_label")
        self.slideshow_voice_role = QtWidgets.QComboBox(self.slideshow_container)
        self.slideshow_voice_role.setMinimumWidth(160)
        self.slideshow_voice_role.setObjectName("slideshow_voice_role")
        self.slideshow_listen_btn = QtWidgets.QPushButton(self.slideshow_container)
        self.slideshow_listen_btn.setObjectName("slideshow_listen_btn")
        self.slideshow_lang_label = QtWidgets.QLabel(self.slideshow_container)
        self.slideshow_lang_label.setStyleSheet("background-color:transparent")
        self.slideshow_lang_label.setObjectName("slideshow_lang_label")
        self.slideshow_language = QtWidgets.QComboBox(self.slideshow_container)
        self.slideshow_language.setMinimumWidth(120)
        self.slideshow_language.setObjectName("slideshow_language")
        self.slideshow_rate_label = QtWidgets.QLabel(self.slideshow_container)
        self.slideshow_rate_label.setStyleSheet("background-color:transparent")
        self.slideshow_rate_label.setObjectName("slideshow_rate_label")
        self.slideshow_voice_rate = QtWidgets.QSpinBox(self.slideshow_container)
        self.slideshow_voice_rate.setMinimum(-100)
        self.slideshow_voice_rate.setMaximum(100)
        self.slideshow_voice_rate.setMinimumWidth(70)
        self.slideshow_voice_rate.setObjectName("slideshow_voice_rate")
        self.slideshow_vol_label = QtWidgets.QLabel(self.slideshow_container)
        self.slideshow_vol_label.setStyleSheet("background-color:transparent")
        self.slideshow_vol_label.setObjectName("slideshow_vol_label")
        self.slideshow_volume = QtWidgets.QSpinBox(self.slideshow_container)
        self.slideshow_volume.setMinimum(-100)
        self.slideshow_volume.setMaximum(100)
        self.slideshow_volume.setMinimumWidth(70)
        self.slideshow_volume.setObjectName("slideshow_volume")
        self.slideshow_row2.addWidget(self.slideshow_tts_label)
        self.slideshow_row2.addWidget(self.slideshow_tts_type)
        self.slideshow_row2.addWidget(self.slideshow_voice_label)
        self.slideshow_row2.addWidget(self.slideshow_voice_role)
        self.slideshow_row2.addWidget(self.slideshow_listen_btn)
        self.slideshow_row2.addWidget(self.slideshow_lang_label)
        self.slideshow_row2.addWidget(self.slideshow_language)
        self.slideshow_row2.addWidget(self.slideshow_rate_label)
        self.slideshow_row2.addWidget(self.slideshow_voice_rate)
        self.slideshow_row2.addWidget(self.slideshow_vol_label)
        self.slideshow_row2.addWidget(self.slideshow_volume)
        self.slideshow_row2.addStretch()
        self.slideshow_layout.addLayout(self.slideshow_row2)

        # Row 3: Video settings - Resolution, FPS, Effect, Transition
        self.slideshow_row3 = QtWidgets.QHBoxLayout()
        self.slideshow_res_label = QtWidgets.QLabel(self.slideshow_container)
        self.slideshow_res_label.setStyleSheet("background-color:transparent")
        self.slideshow_res_label.setObjectName("slideshow_res_label")
        self.slideshow_resolution = QtWidgets.QComboBox(self.slideshow_container)
        self.slideshow_resolution.setMinimumWidth(120)
        self.slideshow_resolution.setObjectName("slideshow_resolution")
        self.slideshow_fps_label = QtWidgets.QLabel(self.slideshow_container)
        self.slideshow_fps_label.setStyleSheet("background-color:transparent")
        self.slideshow_fps_label.setObjectName("slideshow_fps_label")
        self.slideshow_fps = QtWidgets.QSpinBox(self.slideshow_container)
        self.slideshow_fps.setMinimum(1)
        self.slideshow_fps.setMaximum(60)
        self.slideshow_fps.setValue(30)
        self.slideshow_fps.setObjectName("slideshow_fps")
        self.slideshow_effect_label = QtWidgets.QLabel(self.slideshow_container)
        self.slideshow_effect_label.setStyleSheet("background-color:transparent")
        self.slideshow_effect_label.setObjectName("slideshow_effect_label")
        self.slideshow_effect = QtWidgets.QComboBox(self.slideshow_container)
        self.slideshow_effect.setMinimumWidth(100)
        self.slideshow_effect.setObjectName("slideshow_effect")
        self.slideshow_trans_label = QtWidgets.QLabel(self.slideshow_container)
        self.slideshow_trans_label.setStyleSheet("background-color:transparent")
        self.slideshow_trans_label.setObjectName("slideshow_trans_label")
        self.slideshow_transition = QtWidgets.QComboBox(self.slideshow_container)
        self.slideshow_transition.setMinimumWidth(100)
        self.slideshow_transition.setObjectName("slideshow_transition")
        self.slideshow_trans_dur_label = QtWidgets.QLabel(self.slideshow_container)
        self.slideshow_trans_dur_label.setStyleSheet("background-color:transparent")
        self.slideshow_trans_dur_label.setObjectName("slideshow_trans_dur_label")
        self.slideshow_trans_dur = QtWidgets.QDoubleSpinBox(self.slideshow_container)
        self.slideshow_trans_dur.setMinimum(0.1)
        self.slideshow_trans_dur.setMaximum(3.0)
        self.slideshow_trans_dur.setSingleStep(0.1)
        self.slideshow_trans_dur.setValue(0.5)
        self.slideshow_trans_dur.setObjectName("slideshow_trans_dur")
        self.slideshow_row3.addWidget(self.slideshow_res_label)
        self.slideshow_row3.addWidget(self.slideshow_resolution)
        self.slideshow_row3.addWidget(self.slideshow_fps_label)
        self.slideshow_row3.addWidget(self.slideshow_fps)
        self.slideshow_row3.addWidget(self.slideshow_effect_label)
        self.slideshow_row3.addWidget(self.slideshow_effect)
        self.slideshow_row3.addWidget(self.slideshow_trans_label)
        self.slideshow_row3.addWidget(self.slideshow_transition)
        self.slideshow_row3.addWidget(self.slideshow_trans_dur_label)
        self.slideshow_row3.addWidget(self.slideshow_trans_dur)
        self.slideshow_row3.addStretch()
        self.slideshow_layout.addLayout(self.slideshow_row3)

        # Row 4: Background music + options
        self.slideshow_row4 = QtWidgets.QHBoxLayout()
        self.slideshow_bgm_btn = QtWidgets.QPushButton(self.slideshow_container)
        self.slideshow_bgm_btn.setMinimumSize(QtCore.QSize(130, 30))
        self.slideshow_bgm_btn.setObjectName("slideshow_bgm_btn")
        self.slideshow_bgm_label = QtWidgets.QLabel(self.slideshow_container)
        self.slideshow_bgm_label.setObjectName("slideshow_bgm_label")
        self.slideshow_bgm_vol_label = QtWidgets.QLabel(self.slideshow_container)
        self.slideshow_bgm_vol_label.setStyleSheet("background-color:transparent")
        self.slideshow_bgm_vol_label.setObjectName("slideshow_bgm_vol_label")
        self.slideshow_bgm_volume = QtWidgets.QDoubleSpinBox(self.slideshow_container)
        self.slideshow_bgm_volume.setMinimum(0.0)
        self.slideshow_bgm_volume.setMaximum(1.0)
        self.slideshow_bgm_volume.setSingleStep(0.05)
        self.slideshow_bgm_volume.setValue(0.3)
        self.slideshow_bgm_volume.setObjectName("slideshow_bgm_volume")
        self.slideshow_sub_check = QtWidgets.QCheckBox(self.slideshow_container)
        self.slideshow_sub_check.setObjectName("slideshow_sub_check")
        self.slideshow_bitrate_label = QtWidgets.QLabel(self.slideshow_container)
        self.slideshow_bitrate_label.setStyleSheet("background-color:transparent")
        self.slideshow_bitrate_label.setObjectName("slideshow_bitrate_label")
        self.slideshow_bitrate = QtWidgets.QComboBox(self.slideshow_container)
        self.slideshow_bitrate.setMinimumWidth(90)
        self.slideshow_bitrate.setObjectName("slideshow_bitrate")
        self.slideshow_row4.addWidget(self.slideshow_bgm_btn)
        self.slideshow_row4.addWidget(self.slideshow_bgm_label)
        self.slideshow_row4.addWidget(self.slideshow_bgm_vol_label)
        self.slideshow_row4.addWidget(self.slideshow_bgm_volume)
        self.slideshow_row4.addWidget(self.slideshow_sub_check)
        self.slideshow_row4.addWidget(self.slideshow_bitrate_label)
        self.slideshow_row4.addWidget(self.slideshow_bitrate)
        self.slideshow_row4.addStretch()
        self.slideshow_layout.addLayout(self.slideshow_row4)

        # Row 5: Generate button
        self.slideshow_row5 = QtWidgets.QHBoxLayout()
        self.slideshow_generate_btn = QtWidgets.QPushButton(self.slideshow_container)
        self.slideshow_generate_btn.setMinimumSize(QtCore.QSize(200, 36))
        self.slideshow_generate_btn.setObjectName("slideshow_generate_btn")
        self.slideshow_generate_btn.setCursor(Qt.PointingHandCursor)
        self.slideshow_row5.addStretch()
        self.slideshow_row5.addWidget(self.slideshow_generate_btn)
        self.slideshow_row5.addStretch()
        self.slideshow_layout.addLayout(self.slideshow_row5)

        self.slideshow_container.setVisible(False)
        self.verticalLayout_3.addWidget(self.slideshow_container)
...
""")
        ...
        self.action_slideshow = QtGui.QAction(MainWindow)
        self.action_slideshow.setCheckable(True)
        self.action_slideshow.setObjectName("action_slideshow")
        ...
        self.toolBar.addAction(self.action_slideshow)
    ...
    def _set_Ui_Text(self):
        ...
        # Slideshow Creator labels
        self.action_slideshow.setText(tr("Slideshow Creator"))
        self.action_slideshow.setToolTip(tr("Create video from script and images with TTS narration"))
        self.slideshow_script_btn.setText(tr("Select script"))
        self.slideshow_image_btn.setText(tr("Select image folder"))
        self.slideshow_tts_label.setText(tr("Dubbing channel"))
        self.slideshow_voice_label.setText(tr("Dubbing role"))
        self.slideshow_listen_btn.setText(tr("Trial dubbing"))
        self.slideshow_lang_label.setText(tr("Target lang"))
        self.slideshow_res_label.setText(tr("Resolution"))
        self.slideshow_fps_label.setText(tr("FPS"))
        self.slideshow_effect_label.setText(tr("Image effect"))
        self.slideshow_trans_label.setText(tr("Transition"))
        self.slideshow_trans_dur_label.setText(tr("Trans dur"))
        self.slideshow_bgm_btn.setText(tr("Background music"))
        self.slideshow_bgm_vol_label.setText(tr("BGM Volume"))
        self.slideshow_sub_check.setText(tr("Show subtitles"))
        self.slideshow_bitrate_label.setText(tr("Bitrate"))
        self.slideshow_generate_btn.setText(tr("Generate Video"))
        self.slideshow_script_label.setText("")
        self.slideshow_image_label.setText("")
        self.slideshow_bgm_label.setText("")
        self.slideshow_rate_label.setText(tr("Speed"))
        self.slideshow_vol_label.setText(tr("Volume"))
